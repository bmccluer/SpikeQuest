 ...
 */
public class StormCloudObject extends StandardObject implements RainbowRaceObject {
    private static final String[] filePaths = {"object/clouds/storm/StormCloudStand.atlas"};
    private static final String[] fileTypes = {"TextureAtlas"};
    private static final int[] maxFrames = {8};
    private static final float SIZE = 0.5f;
    public Vector2 position;

    public StormCloudObject() {
